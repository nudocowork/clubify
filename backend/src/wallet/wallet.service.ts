...
export class WalletService {
  ...
  private async generateStampsStrip(opts: {
    ...
    // Background del strip: gradiente diagonal + gloss vertical sutil
    // (highlight blanco arriba que se desvanece, oscurecimiento mínimo
    // abajo) para profundidad sin opacar la marca.
