...
export const messages = {
  es: {
    ...
    'checkout.business_name': 'Nombre del negocio',
    'checkout.tax_info': 'Información fiscal',
    ...
    'wallet.info_not_done_sub': 'Guarda tu credencial en el teléfono y llévala siempre contigo.',
    'wallet.info_show': 'Enseña este código cuando te la pidan',
  ...
  en: {
    ...
    'checkout.tax_info': 'Tax information',
    ...
    'card.type_info': 'Membership card',
    ...
    'wallet.info_not_done_sub': 'Save your card to your phone and always have it with you.',
    'wallet.info_show': 'Show this code when asked',
  ...
  pt: {
    ...
    'checkout.notes': 'Notas (opcional)',
    'checkout.business_name': 'Nome da empresa',
    'checkout.tax_info': 'Informação fiscal',
    'checkout.optional': '(opcional)',
    ...
    'wallet.info_not_done_sub': 'Guarde a sua credencial no telemóvel e leve-a sempre consigo.',
    'wallet.info_show': 'Mostre este código quando lhe pedirem',
  ...
  it: {
    ...
    'checkout.business_name': "Nome dell'attività",
    'checkout.tax_info': 'Dati fiscali',
    ...
    'wallet.info_not_done_sub': 'Salva la tua tessera sul telefono e portala sempre con te.',
    'wallet.info_show': 'Mostra questo codice quando te lo chiedono',
