...
// Clon EXACTO de FidelizacionBanner (estructura/espaciados/tamaños idénticos)
// con la paleta NARANJA de Sellea — verde inline (#15803d/#22C55E/rgba green)
// y clases brand → coral. Solo cambian colores; el resto es 1:1.
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, #E63521 0%, #FF4D3D 100%)',
            height: '78%',
          }}
        >
          <div className="px-4 pt-3.5 flex items-start justify-between">
            ...
            <div className="bg-white/15 backdrop-blur rounded-md px-2 py-1">
              ...
              <div className="text-white font-bold text-[14px] leading-none mt-0.5">
                <span style={{ animation: `clb-stamp-count 6s ease-in-out ${delayS}s infinite` }}>
                  7
                </span>
          ...
          <div className="mt-3 px-3 grid grid-cols-5 gap-1.5">
            {Array.from({ length: TOTAL_STAMPS }).map((_, i) => (
              <div
                ...
                style={{
                  background: i < 7 ? 'rgba(255,255,255,0.95)' : 'rgba(255,255,255,0.05)',
                  color: i < 7 ? '#E63521' : 'rgba(255,255,255,0.4)',
            ...
            <div className="bg-white/95 rounded p-1">
              <div className="flex gap-[1px] h-[18px] w-[44px] items-end">
                {[3, 5, 2, 7, 3, 4, 6, 2, 5, 3, 7, 4].map((h, i) => (
                  <div key={i} className="bg-black flex-1" style={{ height: `${50 + h * 6}%` }} />
                ))}
              </div>
            </div>
          </div>
...
export function SelleaFidelizacionBanner({
  waLink,
  demoLink,
}: {
  waLink?: string;
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05]">
              ...
              <span className="text-[#FF4D3D]">Apple y Google Wallet</span>
            </h2>
          ...
          <div className="relative h-[380px] sm:h-[440px] lg:h-[480px] mt-4 lg:mt-0 overflow-visible">
            <div
              ...
              style={{ transform: 'translateY(-45%) rotate(12deg) translateX(20px)', zIndex: 1 }}
            >
            ...
            <div
              ...
              style={{ transform: 'translate(-50%, -50%) rotate(-6deg)', zIndex: 2 }}
            >
              <div className="hidden lg:block">
            ...
            <div
              ...
              style={{ animation: 'clb-wallet-float 4s ease-in-out 1s infinite' }}
            >
              <span>🤖</span>
              Google Wallet
            </div>
            ...
            <div
              ...
              style={{ animation: 'clb-push-cycle 8s ease-in-out infinite', transformOrigin: 'top center' }}
              role="img"
              aria-label="Notificación push de ejemplo"
            >
              <div className="flex items-start gap-2.5">
                <div
                  className="w-9 h-9 rounded-[8px] flex-none flex items-center justify-center text-white shadow-md"
                  style={{ background: 'linear-gradient(135deg, #E63521 0%, #FF4D3D 100%)' }}
                >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-1.5">
                    ...
                    <div className="text-[9px] text-black/40 font-medium flex-none">ahora</div>
                  </div>
            ...
            <div
              ...
              style={{ animation: 'clb-wallet-float 5s ease-in-out 0.5s infinite' }}
              role="img"
              aria-label="Vista de geofence"
            >
              ...
              <div
                ...
                style={{ background: 'linear-gradient(135deg, #FFF1EC 0%, #FFE0D8 100%)' }}
              >
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center">
                  {[0, 1, 2].map((i) => (
                    <span
                      ...
                      style={{
                        background: 'radial-gradient(circle, rgba(255,77,61,0.45) 0%, rgba(255,77,61,0) 70%)',
                        animation: `clb-geo-pulse 2.6s ease-out ${i * 0.85}s infinite`,
                      }}
                    />
                  ))}
                  <div
                    className="relative w-6 h-6 rounded-full bg-[#FF4D3D] shadow-[0_3px_8px_rgba(255,77,61,0.6)] flex items-center justify-center text-white text-[11px] font-bold border-2 border-white"
                    style={{ animation: 'clb-geo-dot 2s ease-in-out infinite' }}
                  >
                    📍
                  </div>
                </div>
